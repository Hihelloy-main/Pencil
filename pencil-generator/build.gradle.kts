...
dependencies {
    minecraftJar(project(":pencil-server", "mappedJarOutgoing"))
    implementation(project(":pencil-server", "macheMinecraftLibraries"))

    implementation("com.squareup:javapoet:1.13.0")
    implementation(project(":pencil-api"))
    implementation("io.papermc.typewriter:typewriter:1.0.1") {
        isTransitive = false // pencil-api already have everything
    }
    ...
    serverRuntimeClasspath(project(":pencil-server", "runtimeConfiguration"))
}
...
val rewriteApi = tasks.registerGenerationTask("rewriteApi", true, "api", {
    bootstrapTags = true
    sourceSet = rootProject.layout.projectDirectory.dir("pencil-api")
}) {
...
val rewriteImpl = tasks.registerGenerationTask("rewriteImpl", true, "impl", {
    sourceSet = rootProject.layout.projectDirectory.dir("pencil-server")
